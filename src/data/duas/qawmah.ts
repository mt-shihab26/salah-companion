...
export const qawmahDuas: DuaVariation[] = [
    // ─── Dua 14 ──────────────────────────────────────────────────────────────
    {
        id: 'qawmah-1',
        positionId: 'qawmah',
        ...
        translations: {
            en: 'Allah hears the one who praises Him. Our Lord, and to You is all praise.',
            ar: 'سمع الله لمن حمده، ربنا ولك الحمد.',
            fr: 'Allah entend celui qui Le loue. Notre Seigneur, et à Toi est toute louange.',
    ...
    // ─── Dua 15 ──────────────────────────────────────────────────────────────
    {
        ...
        translations: {
            en: 'Allah hears the one who praises Him. O Allah, our Lord, to You is all praise that fills the heavens, fills the earth, and fills whatever else You will.',
            ar: 'سمع الله لمن حمده، اللهم ربنا لك الحمد ملء السماوات وملء الأرض وملء ما شئت من شيء بعد.',
            fr: 'Allah entend celui qui Le loue. O Allah notre Seigneur, à Toi est toute louange qui remplit les cieux, remplit la terre, et remplit tout ce que Tu veux en plus.',
    ...
    // ─── Dua 16 ──────────────────────────────────────────────────────────────
    {
        ...
        translations: {
            en: "Our Lord, to You is all praise that fills the heavens, fills the earth, and fills whatever else You will. You are the Most Worthy of praise and glory — the most deserving of what a servant can say. We are all Your servants. O Allah, none can withhold what You give, none can give what You withhold, and no person's wealth or status can benefit them against You.",
            ar: 'ربنا لك الحمد ملء السماوات والأرض وملء ما شئت من شيء بعد، أهل الثناء والمجد، أحق ما قال العبد، وكلنا لك عبد...',
            fr: 'Notre Seigneur, à Toi est toute la louange qui remplit les cieux et la terre... Ô Allah, nul ne peut retenir ce que Tu donnes, et nul ne peut donner ce que Tu retiens.',
    ...
    // ─── Dua 17 ──────────────────────────────────────────────────────────────
    {
        ...
        translations: {
            en: 'O Allah, to You is all praise that fills the heavens, fills the earth, and fills whatever else You will. O Allah, purify me with snow, hail and cold water. O Allah, cleanse me of sins and mistakes as a white garment is cleansed of filth.',
            ar: 'اللهم لك الحمد ملء السماء وملء الأرض... اللهم طهرني بالثلج والبرد والماء البارد...',
            fr: "O Allah, à Toi est toute louange... O Allah, purifie-moi avec la neige, la grêle et l'eau froide... O Allah, nettoie-moi de mes péchés comme un vêtement blanc est nettoyé de la saleté.",
